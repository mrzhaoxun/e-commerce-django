...
class MainShow(Main):
    """
    axf_mainshow(trackid,name,img,categoryid,brandname,img1,childcid1,productid1,
...
class Users(models.Model):
    ...
    u_defaultaddress = models.IntegerField(default=0)
...
class Cart(models.Model):
    ...
    c_goods = models.ForeignKey(Goods, on_delete=models.SET(0))
...
class Order(models.Model):
    ...
    o_remarks = models.TextField(default='未备注')
...
class OrderGoods(models.Model):
    ...
    o_goods = models.ForeignKey(Goods, on_delete=models.SET('lost'))
...
class Address(AddressModel):
    a_user = models.ForeignKey(Users, on_delete=models.CASCADE)

    class Meta:
        db_table = 'axf_address'


class OrderAddress(AddressModel):
    a_order = models.ForeignKey(Order, on_delete=models.CASCADE, unique=True)
